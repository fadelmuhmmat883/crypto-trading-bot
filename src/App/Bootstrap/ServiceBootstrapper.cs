using CtyBot.App.Commands;
using CtyBot.ChainProviders.Evm;
using CtyBot.ChainProviders.Transport;
using CtyBot.ChainProviders.Utxo;
using CtyBot.Cryptography.Derivation;
using CtyBot.Cryptography.Vault;
using CtyBot.Engine.Analytics;
using CtyBot.Engine.Domain.Contracts;
using CtyBot.Engine.Networks;
using CtyBot.Engine.Options;
using CtyBot.Engine.Orchestration;
using CtyBot.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace CtyBot.App.Bootstrap;
